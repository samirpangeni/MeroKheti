    ...
    <div className="flex gap-2 w-full h-screen">
      ...
      <div className="w-full p-2 md:px-20 md:pl-70 pt-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-card p-5 rounded-3xl border border-input-border">
          ...
          <div className="bg-card p-5 rounded-3xl border border-input-border">
            <p className="text-muted text-sm">Cart</p>
        ...
        {/* Recent Orders */}
        <div className="bg-card rounded-3xl border border-input-border p-4 sm:p-6 mb-8">
          {/* Header */}
              ...
              {activity?.map((item) => (
                <div
                  ...
                  className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 
                     p-4 rounded-xl bg-card hover:bg-input-border transition"
                >
                  <div>
